...
<script>
    ...
    $(document).ready(function(){
        ...
        notaid = sessionStorage.getItem('historynotaid');
        datepengiriman = sessionStorage.getItem('historynotapengiriman');
        getnota();
        // alert(notaid);
...
<div class="content" id="content">
    <ul class="breadcrumb">
                ...
                <li><a href="/skripsi/apps/history_pengiriman/historypengiriman.php" class="active">List Pengiriman</a> </li>
                <li><a href="/skripsi/apps/history_pengiriman/historynotapengiriman.php" class="active">Nota Pengiriman</a> </li>
            </ul>
</div>
