...
<script>
    ...
    $(document).ready(function(){
        ...
        keynota = sessionStorage.getItem('historydetailpengirimanidnota');
        // alert(keynota);
        keydetailpenjualan = sessionStorage.getItem('historydetailpengirimankey');
        // alert(keydetailpenjualan);
        var detaillatitude = sessionStorage.getItem('historydetailpengirimanlatitude');
        var detaillatitude = parseFloat(detaillatitude);
        var detaillongitude = sessionStorage.getItem('historydetailpengirimanlongitude');
        var detaillongitude = parseFloat(detaillongitude);
        // alert(typeof detaillatitude);
        // alert(detaillongitude);
        document.getElementById('address-detail').value = sessionStorage.getItem('historydetailpengirimandetailaddress');
        document.getElementById('namePlace').value = sessionStorage.getItem('historydetailpengirimannamapembeli');
        document.getElementById('statusPesanan').value = sessionStorage.getItem('historydetailpengirimanstatuspenjualan');
      ...
      <div class="page-content">
        ...
        <div class="content">
            <ul class="breadcrumb">
                ...
                <li><a href="/skripsi/apps/history_pengiriman/historypengiriman.php" class="#">List Pengiriman</a> </li>
                <li><a href="/skripsi/apps/history_pengiriman/historydetailpengiriman.php" class="active">Detail Pengiriman</a> </li>
            </ul>
            <div class="page-title">
                <h3>Riwayat Pengiriman - <span class="semi-bold">List Pengiriman</span></h3>
            </div>
