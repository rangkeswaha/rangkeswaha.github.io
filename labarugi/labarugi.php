    ...
    $(document).on("click",".pilihBarang",function(){
        ...
        $.ajax({
            ...
            success:function(isi)
            {
                ...
                // alert(typeof isi);
                // alert(isi);  
                document.getElementById('FIFOtext').value = "Rp " + parseFloat(isi).toLocaleString('en');
                        ...
                        <div class="form-group">
                            ...
                            <div class="row form-row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input name="FIFOtext" id="FIFOtext" disabled type="text"
                                        class="form-control" placeholder="Laba Kotor" value="">
                                </div>
                                <!-- <div class="col-md-4">
